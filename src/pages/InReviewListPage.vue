...
<template>
  <section class="space-y-4">
    <header class="space-y-2">
      <h1 class="text-xl font-semibold text-slate-900">{{ $t('list.inReviewTitle') }}</h1>
      <p class="text-sm text-slate-600">{{ $t('list.inReviewSubtitle') }}</p>
    </header>
